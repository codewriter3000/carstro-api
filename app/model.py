...
def migrate():
    ...
    cursor.execute('CREATE TABLE users (id serial PRIMARY KEY, username VARCHAR(20), password_digest CHAR(100), password_salt VARCHAR(8), first_name VARCHAR(16), last_name VARCHAR(16));')
